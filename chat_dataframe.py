...
def generate_pdf(data, filename="customer_report.pdf"):
    ...
    for report in data:
        ...
        c.drawString(100, y_position, "Email")
        c.drawString(250, y_position, "Phone")
        c.drawString(350, y_position, "Price")
        c.drawString(450, y_position, "Quantity")
        c.drawString(500, y_position, "Date")
        y_position -= 15
        ...
        for customer in report['customer_list']:
            ...
            c.drawString(100, y_position, customer['email'])
            c.drawString(250, y_position, customer['phone'])
            c.drawString(350, y_position, f"${customer['price']}")
            c.drawString(450, y_position, f"{customer['quantity']}")
            c.drawString(500, y_position, customer['date'])
            y_position -= 15
