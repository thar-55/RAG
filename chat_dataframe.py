...
def generate_pdf(data, filename="customer_report.pdf"):
    ...
    for report in data:
        ...
        c.drawString(300, y_position, "Phone")
        ...
        for customer in report['customer_list']:
            ...
            c.drawString(300, y_position, customer['phone'])
            c.drawString(350, y_position, f"${customer['price']}")
            c.drawString(400, y_position, f"{customer['quantity']}")
            c.drawString(450, y_position, customer['date'])
            y_position -= 15
