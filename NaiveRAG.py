...
if query:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are an AI assistant. Use the following context to answer questions.If context is not provided Display like I'm RAG AI. You should upload any pdf or csv docs or web url. I can assist you if you provide docs or url"),
        ("user", "{query}\n\nContext:\n{context}")
    ])
